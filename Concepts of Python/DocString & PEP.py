...
Docstring will not directly appear in output;
...
"""
def square(n):
    # It's a type of a doc_string;
    '''Takes in the number [n] and returns the square of [n]; 
    '''
    print(n**2)

square(5)
print(square.__doc__) # It's write above the function body or below the function name;
